...
author: "Analytics, Pricing, IBP Professional"
output:
  html_document:
    toc: true
    toc_float: true
...
+:---------------------+---------------------------------------------------------------------------------------------------:+
| 209 Court Drive      | [jonathan.todd.oxborrow\@gmail.com](mailto:jonathan.todd.oxborrow@gmail.com "Email me!!!"){.email} |
|                      |                                                                                                    |
| Washington, IL 61571 |                                                                                                    |
|                      |                                                                                                    |
| USA                  |                                                                                                    |
...
##### **Senior Analytics Team Lead - Parts Pricing**
...
+----------------------+-----------------------------------------------------------------------------------------+
| Leadership Qualities | -   Communication ‐ Demonstrated strong communicator, both verbal and written.          |
...
+----------------------------------+-----------------------------------------------------------------------+
| Programming Languages & Software | -   Proficient: R, SQL, git, and MSOffice/VBA.                        |
|                                  | -   Experienced: Tableau, SAS, STATA, EViews, C/C\#, shell scripting. |
|                                  | -   Functional: Python, VBScript, Javascript/JQuery, docker           |
+----------------------------------+-----------------------------------------------------------------------+

+------------+-----------------------------------------------------------------------------------------+
| Statistics | -   Proficient: Time Series Modeling & Forecasting, Seasonal Adjustment, Regression/GLM |
